          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="{{route('ijin.index')}}" class="nav-link">
                    <i class="nav-icon fas fa-edit"></i>
                    <p>Perijinan</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="{{route('serta.index')}}" class="nav-link">
                    <i class="nav-icon fas fa-edit"></i>
                    <p>Sertifikat</p>
                  </a>
                </li>
          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{route('removesession')}}">
                    {{session('bPeriode')}} <i class="fas fa-calendar-check"></i></a></li>
