!(function (n, t) {
    ...
    var n = {
        ...
        x = function (n) {
            ...
            "function" == typeof n.animation &&
                (n.animation = n.animation.call()),
                n.showCloseButton
                    ? (g.setAttribute("aria-label", n.closeButtonAriaLabel),
                      G(g))
                    : nn(g),
                (t.className = o.popup),
                n.toast
        ...
        y = function () {
            if (
                ...
                (document.body.style.top = -1 * n + "px"),
            ...
            if ("undefined" != typeof window) {
                ...
                return new Promise(function (t, e) {
                    ...
                    for (
                        var f = function (t) {
                                if (
                                    (s.showLoaderOnConfirm && n.showLoading(),
                                    s.preConfirm)
                                ) {
                    ...
                    s.toast && g && ((window.onkeydown = b), (g = !1)),
                        ...
                        (n.enableInput = function () {
                            ...
                            if ("radio" === n.type)
                                for (
                                    var t =
                                            n.parentNode.parentNode.querySelectorAll(
                                                "input"
                                            ),
                                        e = 0;
                                    e < t.length;
                    ...
                    (wn = s.animation),
                        ...
                        wn
                            ? (Q(mn, o.show), Q(fn, o.fade), F(mn, o.hide))
                            : F(mn, o.fade),
                        G(mn),
                        (fn.style.overflowY = "hidden"),
                        an && !W(mn, o.noanimation)
                            ? mn.addEventListener(an, function n() {
                                  mn.removeEventListener(an, n),
                                      (fn.style.overflowY = "auto");
                              })
                            : (fn.style.overflowY = "auto"),
                        Q(
                            [document.documentElement, document.body, fn],
                            o.shown
                        ),
                        X() && (k(), y()),
